          ...
          <div className="relative bg-card/80 backdrop-blur-xl border border-border/50 rounded-2xl shadow-xl shadow-foreground/5 overflow-hidden">
            {inspectorMode === 'output' ? (
                        ...
                        >
                          ...
                          <span
                            className={cn(
                              ...
                              isActive ? 'bg-demo-warm/20 text-demo-warm' : 'bg-muted text-muted-foreground',
                            )}
                          >
              ...
              <div className="p-6">
                ...
                {/* Action buttons */}
                <div className="flex items-center gap-3">
                  <Button onClick={handleRender} disabled={!importText.trim()} className="flex-1 gap-2 h-11">
    ...
    () =>
      createMentionPlugin({
        onSearch: async (query) => {
          ...
          return sampleUsers.filter((u) => u.label.toLowerCase().includes(query.toLowerCase()))
        },
  ...
  const features = [
    {
      ...
      description:
        'Bold, italic, underline, strikethrough, code, and more. Everything you need for expressive writing.',
    },
    {
      icon: Terminal,
